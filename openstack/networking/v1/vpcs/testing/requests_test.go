...
func TestList(t *testing.T) {
	...
	th.Mux.HandleFunc("/v1/vpcs", func(w http.ResponseWriter, r *http.Request) {
...
func TestGet(t *testing.T) {
	...
	th.Mux.HandleFunc("/v1/vpcs/abda1f6e-ae7c-4ff5-8d06-53425dc11f34", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
		th.TestHeader(t, r, "X-Auth-Token", fake.TokenID)
		...
		th.TestJSONRequest(t, r, `
{
 "vpc":
     {
     "name": "terraform-provider-vpctest",
     "cidr": "192.168.0.0/16"
     }
}
			`)
		...
		fmt.Fprintf(w, `
{
	...
	th.AssertNoErr(t, err)
	th.AssertEquals(t, "terraform-provider-vpctest", n.Name)
...
func TestUpdate(t *testing.T) {
	...
	th.Mux.HandleFunc("/v1/vpcs/97e01fc2-e39e-4cfc-abf6-1d0886d120af", func(w http.ResponseWriter, r *http.Request) {
